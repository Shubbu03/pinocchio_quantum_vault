...
use pinocchio_quantum_vault::instructions::Initialize;
use pinocchio_quantum_vault::states::{to_bytes, VaultState};
use solana_sdk::rent::Rent;
use solana_sdk::sysvar::Sysvar;

pub const PROGRAM: Pubkey = pubkey!("HPp4cx5cigaRBzff6YreZtQ8RoqjZJ3CSPFfd4PmUX7P");
...
pub fn mollusk() -> Mollusk {
    let mollusk = Mollusk::new(&PROGRAM, "target/deploy/pinocchio_quantum_vault");
    mollusk
}
